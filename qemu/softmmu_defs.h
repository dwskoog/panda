...
uint8_t __ldb_mmu_panda(target_ulong addr, int mmu_idx);
void __stb_mmu_panda(target_ulong addr, uint8_t val, int mmu_idx);
uint16_t __ldw_mmu_panda(target_ulong addr, int mmu_idx);
void __stw_mmu_panda(target_ulong addr, uint16_t val, int mmu_idx);
uint32_t __ldl_mmu_panda(target_ulong addr, int mmu_idx);
void __stl_mmu_panda(target_ulong addr, uint32_t val, int mmu_idx);
uint64_t __ldq_mmu_panda(target_ulong addr, int mmu_idx);
void __stq_mmu_panda(target_ulong addr, uint64_t val, int mmu_idx);
